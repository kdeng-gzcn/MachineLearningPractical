...
class ConvolutionalProcessingBatchNormBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        """
        Initializes Improved Process Conv Block
        :param input_shape: The shape of the tensor to be passed into this network
        :param num_filters: The num of channels for output
        :param kernel_size: kernel size for conv network
        :param padding: padding for conv network
        :param bias: bias for conv network
        :param dilation: dilation for conv network
        """
        super(ConvolutionalProcessingBatchNormBlock, self).__init__()
...
class ConvolutionalDimensionalityReductionBatchNormBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        """
        Initializes Improved Dim Reduction Conv Block
        :param input_shape: The shape of the tensor to be passed into this network
        :param num_filters: The num of channels for output
        :param kernel_size: kernel size for conv network
        :param padding: padding for conv network
        :param bias: bias for conv network
        :param dilation: dilation for conv network
        :param reduction_factor: the number of deduction on channels of output
        """
        super(ConvolutionalDimensionalityReductionBatchNormBlock, self).__init__()
...
class ConvolutionalProcessingBatchNormResidualBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        """
        Initializes Improved Process Conv Block
        :param input_shape: The shape of the tensor to be passed into this network
        ...
        :param dilation: dilation for conv network
        """
        super(ConvolutionalProcessingBatchNormResidualBlock, self).__init__()
    ...
    def build_module(self):
        ...
        # Add Input and Block(Input)
        if residual.shape == out.shape:
            out += residual 
        else:
            print("Input and Output dismatch in size.")
