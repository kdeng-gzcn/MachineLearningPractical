if __name__ == "__main__":
    ...
    elif args.block_type == 'conv_BN_block': # add BatchNorm Block
        processing_block_type = ConvolutionalProcessingBatchNormBlock
        dim_reduction_block_type = ConvolutionalDimensionalityReductionBatchNormBlock
    elif args.block_type == 'conv_BN_RC_block': # add BatchNorm Residual Block
        processing_block_type = ConvolutionalProcessingBatchNormResidualBlock
        dim_reduction_block_type = ConvolutionalDimensionalityReductionBatchNormBlock
    else:
    ...
    conv_experiment = ExperimentBuilder(network_model=custom_conv_net,
                                        ...
                                        lr=args.lr)  # add arg learning rate
